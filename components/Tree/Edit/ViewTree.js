  ...
  return (
    <View className="flex items-center gap-4">
      ...
      <View className="flex items-center bg-slate-400 shadow-lg px-10 py-4 rounded-xl">
        ...
        {workingTree.properties.needsWork && <Text className="text-white font-bold text-lg">
        ...
        <Text className="text-white font-bold text-lg">
          Coordinates: [{workingTree.geometry.coordinates[0].toFixed(5)}, {workingTree.geometry.coordinates[1].toFixed(5)}]
        </Text>
      </View>
    </View>
  );
