...
const Main = () => {
    ...
    const { location, setLocation, errMsg, setErrMsg, sliderRef, mapRef, camera, trees, setTrees, tempTreeForm, setTempTreeForm, sites, setSites, sliderTitle, setSliderTitle, showSplash, setShowSplash, selectedTrees, setSelectedTrees, selectedSite, setSelectedSite, showAddSite, setShowAddSite, showAddTree, setShowAddTree, customMark, setCustomMark, showCustomMark, setShowCustomMark, showCustomTree, setShowCustomTree, showSelectedSite, setShowSelectedSite } = useContext(ScreenContext);
